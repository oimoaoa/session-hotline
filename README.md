...
>
> - **새로 설치하는 건 권하지 않아요**. Codex 앱이 업데이트되면서 **Claude 방 ↔ Codex 방 사이로 물어볼 때 우회가 필요한 상태**라는 걸 확인했어요. 이 스킬은 데스크탑 앱의 내부 파일 구조에 기대는 구조라, Claude Code·Codex 앱이 업데이트되면 지금처럼 어긋날 수 있어요 — 그리고 그걸 더는 고치지 않습니다.
